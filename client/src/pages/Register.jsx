        ...
        <div className="hidden flex-col justify-between bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-8 text-white lg:flex lg:w-[46%]">
          <div>
            ...
            <h2 className="text-3xl font-bold leading-tight">
              Create your Customer Registry account
            </h2>
            <p className="mt-4 text-sm leading-6 text-slate-300">
              Start managing cases, coordinating support, and keeping every
              customer interaction organized in a single professional workspace.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold">Secure and role-aware</p>
                <p className="text-xs text-slate-300">
                  Built for admins, agents, and customers alike.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full p-8 sm:p-10 lg:w-[54%] lg:p-10">
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Sign up to begin managing complaints professionally.
            </p>
          </div>
